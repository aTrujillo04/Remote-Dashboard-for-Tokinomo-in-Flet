import flet as ft #Import flet library
import requests #Import requests library
from service import control_gadget, set_motor_pwm #Import functions from service.py 

def main(page: ft.Page): #Main function defined 
    ...
    gadget_states = {"ilumination": False, "sound": False, "routine": False, "motor": False} #Initial states of gadgets
    data_mapping = {"Ilumination": "ilumination", "Sound": "sound", "Routine": "routine", "Motor": "motor"} #Mapping for display names to internal keys
...
if __name__ == "__main__":
    ft.app(target=main) #Run the app with main function as target
